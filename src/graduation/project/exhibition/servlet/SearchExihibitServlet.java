...
import graduation.project.exhibition.dao.SearchExhibitDAO;
...
// 对应的Servlet地址
public class SearchExihibitServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public SearchExihibitServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		// 利用DAO读取数据并返回
		SearchExhibitDAO.get(key,new SimpleOnGetResultSetListener() {
